...
(lexicals, run_lexer) = lexer(r(FLOAT='[-+]?[0-9]+\\.\\d+([eE][-+]?\\d+)?|[-+]?[0-9]+[eE][-+]?\\d+'), r(INT='[-+]?\\d+'), r(UPPER="[A-Z][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(LOWER="[a-z_\\u4e00-\\u9fa5][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(STRING='"([^\\\\"]+|\\\\.)*?"'), r(SPECIAL='\\-\\>|\\=\\>|\\=|\\=\\='), r(OP='[\\+\\-\\*\\/\\@\\~\\%\\>\\<][\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]*'), r(SOP='\\|[\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]+'), r(COMMENT='#[^\\n\\r]*'), r(W='\\s+'), l['}'], l['|'], l['{'], l['`'], l['^'], l[']'], l['['], l['::'], l[':'], l['.'], l[','], l[')'], l['('], l['$'], ignores=['W', 'COMMENT'], reserved_map=ImmutableMap.from_dict({'module': 'quote module', 'rec': 'quote rec', '.': 'quote .', 'let': 'quote let', '=': 'quote =', ':': 'quote :', 'fn': 'quote fn', 'type': 'quote type', 'tellme': 'quote tellme', 'import': 'quote import', ',': 'quote ,', '|': 'quote |', '(': 'quote (', ')': 'quote )', '->': 'quote ->', '^': 'quote ^', 'when': 'quote when', '[': 'quote [', ']': 'quote ]', '{': 'quote {', '}': 'quote }', 'and': 'quote and', 'or': 'quote or', '::': 'quote ::', '==': 'quote ==', 'in': 'quote in', 'if': 'quote if', 'then': 'quote then', 'else': 'quote else', 'fun': 'quote fun', 'match': 'quote match', 'True': 'quote True', 'False': 'quote False', '`': 'quote `', '$': 'quote $', 'coerce': 'quote coerce', 'typeval': 'quote typeval', 'extern': 'quote extern', 'forall': 'quote forall', 'exist': 'quote exist', '=>': 'quote =>', 'valtype': 'quote valtype'}), numbering={'BOF': 0, 'EOF': 1, 'quote module': 2, 'quote rec': 3, 'quote .': 4, 'quote let': 5, 'quote =': 6, 'quote :': 7, 'quote fn': 8, 'quote type': 9, 'quote tellme': 10, 'quote import': 11, 'quote ,': 12, 'quote |': 13, 'quote (': 14, 'quote )': 15, 'quote ->': 16, 'quote ^': 17, 'quote when': 18, 'quote [': 19, 'quote ]': 20, 'quote {': 21, 'quote }': 22, 'quote and': 23, 'quote or': 24, 'quote ::': 25, 'quote ==': 26, 'quote in': 27, 'quote if': 28, 'quote then': 29, 'quote else': 30, 'quote fun': 31, 'quote match': 32, 'quote True': 33, 'quote False': 34, 'quote `': 35, 'quote $': 36, 'quote coerce': 37, 'quote typeval': 38, 'quote extern': 39, 'quote forall': 40, 'quote exist': 41, 'quote =>': 42, 'quote valtype': 43, 'FLOAT': 44, 'INT': 45, 'UPPER': 46, 'LOWER': 47, 'STRING': 48, 'SPECIAL': 49, 'OP': 50, 'SOP': 51, 'COMMENT': 52, 'W': 53})



def mk_parser(ite_k, extern_k, import_k, mutual_k, lit_k, coerce_k, module_k, def_k, let_k, type_k, and_k, or_k, quote_k, unquote_k, lambda_k, match_k, ann_k, bin_k, case_k, list_k, tuple_k, record_k, call_k, arrow_k, imply_k, loc_k, forall_k, exist_k, guard_k, pin_k, uncall_k, alias_k, attr_k, tellme_k, loc_, loc, DQString):
    ...
    def lr_step_qualified__type(_slot_0, prim__state, prim__tokens):
        lcl_0 = 4
        try:
            _py_local_tk = prim__tokens.array[prim__tokens.offset]
            if (_py_local_tk.idint is lcl_0):
    ...
    def lr_loop_qualified__type(_slot_0, prim__state, prim__tokens):
        lr_qualified__type_reduce = _slot_0
        lcl_0 = prim__tokens.offset
        _off_0 = lcl_0
        lcl_0 = lr_step_qualified__type(lr_qualified__type_reduce, prim__state, prim__tokens)
        lr_qualified__type_try = lcl_0
        lcl_0 = lr_qualified__type_try[0]
        lcl_0 = (lcl_0 is not False)
        while lcl_0:
            lcl_1 = prim__tokens.offset
            _off_0 = lcl_1
            lcl_1 = lr_qualified__type_try[1]
            lcl_1 = lcl_1
            lr_qualified__type_reduce = lcl_1
            lcl_1 = lr_step_qualified__type(lr_qualified__type_reduce, prim__state, prim__tokens)
            lr_qualified__type_try = lcl_1
            lcl_1 = lr_qualified__type_try[0]
            lcl_1 = (lcl_1 is not False)
            lcl_0 = lcl_1
        lcl_0 = prim__tokens.offset
        lcl_0 = (lcl_0 is _off_0)
        if lcl_0:
            lcl_1 = (True, lr_qualified__type_reduce)
            lcl_0 = lcl_1
        else:
            lcl_0 = lr_qualified__type_try
        return lcl_0
    ...
    def parse_atom__type(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if (lcl_2 == 21):
                ...
                lcl_3 = parse_qualified__type(prim__state, prim__tokens)
                _slot_0_check = lcl_3
                lcl_3 = _slot_0_check[0]
                lcl_3 = (lcl_3 is False)
                if lcl_3:
    ...
    def parse_expr(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if (lcl_2 == 13):
                ...
                lcl_3 = _py_local_t
                _slot_0 = lcl_3
                lcl_3 = parse_String(prim__state, prim__tokens)
                _slot_1_check = lcl_3
                lcl_3 = _slot_1_check[0]
                lcl_3 = (lcl_3 is False)
                if lcl_3:
                ...
                lcl_3 = _py_local_t
                _slot_0 = lcl_3
                lcl_3 = parse_rbnf__sep__list__7(prim__state, prim__tokens)
                _slot_1_check = lcl_3
                lcl_3 = _slot_1_check[0]
                lcl_3 = (lcl_3 is False)
                if lcl_3:
                ...
                if lcl_3:
                    ...
                    if lcl_4:
                        ...
                        if lcl_5:
                            ...
                            lcl_6 = _slot_1
                            lcl_7 = _slot_3
                            lcl_6 = (let__k, False, lcl_6, lcl_7)
                            lcl_7 = _slot_0
                            lcl_6 = loc__(lcl_6, lcl_7)
                            _slot_local__1 = lcl_6
                            lcl_6 = lr_loop_expr(_slot_local__1, prim__state, prim__tokens)
                        ...
                        if lcl_5:
                            ...
                            if lcl_6:
                                ...
                                if lcl_7:
                                    ...
                                    lcl_9 = _slot_3
                                    lcl_10 = _slot_5
                                    lcl_10 = (ite__k, lcl_8, lcl_9, lcl_10)
                                    lcl_8 = _slot_0
                                    lcl_10 = loc__(lcl_10, lcl_8)
                                    _slot_local__1 = lcl_10
                ...
                lcl_10 = _py_local_t
                _slot_0 = lcl_10
                lcl_10 = parse_ml__lambda(prim__state, prim__tokens)
                ...
                if lcl_10:
                    ...
                    lcl_3 = loc__(lcl_3, lcl_4)
                    _slot_local__1 = lcl_3
                    lcl_3 = lr_loop_expr(_slot_local__1, prim__state, prim__tokens)
                    lcl_10 = lcl_3
                lcl_1 = lcl_10
            elif (lcl_2 == 39):
    ...
    def parse_ml__lambda(prim__state, prim__tokens):
        lcl_0 = parse_pat(prim__state, prim__tokens)
        _slot_0_check = lcl_0
        lcl_0 = _slot_0_check[0]
        lcl_0 = (lcl_0 is False)
        if lcl_0:
            ...
            lcl_1 = lcl_1
            _slot_0 = lcl_1
            lcl_1 = parse_ml__lambda__typed(prim__state, prim__tokens)
            _slot_1_check = lcl_1
            lcl_1 = _slot_1_check[0]
            lcl_1 = (lcl_1 is False)
            if lcl_1:
            ...
            if lcl_1:
                ...
                if (lcl_3 == 3):
                    ...
                    if lcl_4:
                        ...
                        lcl_5 = lcl_5
                        _slot_2 = lcl_5
                        lcl_5 = parse_rbnf__list__0(prim__state, prim__tokens)
                        _slot_3_check = lcl_5
                        lcl_5 = _slot_3_check[0]
                        lcl_5 = (lcl_5 is False)
                        if lcl_5:
                            ...
                            lcl_6 = _slot_2
                            lcl_7 = _slot_3
                            lcl_6 = (module__k, True, lcl_6, lcl_7)
                            lcl_7 = _slot_0
                            lcl_6 = loc__(lcl_6, lcl_7)
                            _slot_local__1 = lcl_6
                            lcl_6 = (True, _slot_local__1)
                    ...
                    if lcl_4:
                        ...
                        if lcl_5:
                            ...
                            lcl_6 = _slot_1
                            lcl_7 = _slot_2
                            lcl_6 = (module__k, False, lcl_6, lcl_7)
                            lcl_7 = _slot_0
                            lcl_6 = loc__(lcl_6, lcl_7)
                            _slot_local__1 = lcl_6
                            lcl_6 = (True, _slot_local__1)
                    ...
                    lcl_4 = (_off_1, 'module_def lookahead failed')
                    lcl_4 = prim__cons(lcl_4, prim__nil)
                    lcl_4 = lcl_4
                    lcl_4 = (False, lcl_4)
                    lcl_2 = lcl_4
                ...
                lcl_2 = (_off_1, 'module_def got EOF')
                lcl_2 = prim__cons(lcl_2, prim__nil)
                lcl_2 = lcl_2
                lcl_2 = (False, lcl_2)
                lcl_1 = lcl_2
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                if (lcl_3 == 6):
                    ...
                    if lcl_4:
                        ...
                        if lcl_5:
                            ...
                            if lcl_6:
                                ...
                                lcl_9 = _slot_2
                                lcl_10 = _slot_4
                                lcl_10 = (lcl_7, lcl_8, lcl_9, lcl_10)
                                _slot_local__1 = lcl_10
                                lcl_10 = (True, _slot_local__1)
                                lcl_6 = lcl_10
                            lcl_5 = lcl_6
                    ...
                    lcl_10 = (_off_0, 'mutual_case lookahead failed')
                    lcl_10 = prim__cons(lcl_10, prim__nil)
                    lcl_10 = lcl_10
                    lcl_10 = (False, lcl_10)
                    lcl_2 = lcl_10
                ...
                lcl_10 = (_off_0, 'mutual_case got EOF')
                lcl_10 = prim__cons(lcl_10, prim__nil)
                lcl_10 = lcl_10
                lcl_10 = (False, lcl_10)
                lcl_1 = lcl_10
    ...
    def parse_qualified__type(prim__state, prim__tokens):
        lcl_0 = parse_ID(prim__state, prim__tokens)
        _slot_0_check = lcl_0
        lcl_0 = _slot_0_check[0]
        lcl_0 = (lcl_0 is False)
        if lcl_0:
            ...
            lcl_1 = _slot_0
            _slot_local__1 = lcl_1
            lcl_1 = lr_loop_qualified__type(_slot_local__1, prim__state, prim__tokens)
            lcl_0 = lcl_1
        return lcl_0
    ...
    def parse_top__level(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if (lcl_2 == 9):
                ...
                lcl_10 = _py_local_t
                _slot_0 = lcl_10
                lcl_10 = parse_String(prim__state, prim__tokens)
                _slot_1_check = lcl_10
                lcl_10 = _slot_1_check[0]
                lcl_10 = (lcl_10 is False)
                if lcl_10:
                ...
                if lcl_10:
                    ...
                    if lcl_11:
                        ...
                        if (lcl_3 == 6):
                            ...
                            lcl_4 = _py_local_t
                            _slot_2 = lcl_4
                            lcl_4 = parse_ml__lambda(prim__state, prim__tokens)
                            _slot_3_check = lcl_4
                            lcl_4 = _slot_3_check[0]
                            lcl_4 = (lcl_4 is False)
                            if lcl_4:
                            ...
                            if lcl_4:
                                ...
                                if lcl_5:
                                    ...
                                    lcl_6 = parse_ml__lambda(prim__state, prim__tokens)
                                    _slot_5_check = lcl_6
                                    lcl_6 = _slot_5_check[0]
                                    lcl_6 = (lcl_6 is False)
                                    if lcl_6:
